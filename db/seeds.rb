...
Activity.create(date: Date.today, event: Event.last, start_time: '12:00', end_time: '14:00', category: "eat", address: "1 Hoxton", name: "Dishoom", booked: true, saved: true, details: "Round table booked outside.", image_url: "eat/restaurant 1.jpg")
...
Activity.create(date: Date.today, event: Event.last, start_time: '17:30', end_time: '20:00', category: "eat", address: "1 Haggerston", name: "Glorias", booked: true, saved: true, details: "Private room for dinner.", image_url: "eat/restaurant 2.jpg" )
