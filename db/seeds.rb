...
Activity.create(date: Date.today, event: Event.last, start_time: '12:00', end_time: '14:00', category: "eat", address: "1 Hoxton", name: "Dishoom", booked: true, saved: true, details: "Round table booked outside.")
